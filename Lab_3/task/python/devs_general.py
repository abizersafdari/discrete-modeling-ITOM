...
def runGeneral(serviceTimes, arrivalTimes, maxAngents):
    iteration = 0
    ...
    class ArrivalEvent:
        ...
        def Execute(self):
            ...
            if any(x == -1 for x in DEVS.servers):
                ...
                print("server %i"%customer.id,"is Busy")
    ...
    class ServiceEvent:
        ...
        def Execute(self):
            ...
            print("Time %d"%self.eTime,"Service for server %i"%serverId,"is finished")
    ...
    DrawSampleHistogram([x.waitingTimeInQueue for x in DEVS.stats],"general")
