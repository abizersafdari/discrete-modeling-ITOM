...
def runShortest(serviceTimes, arrivalTimes, maxAngents):
    iteration = 0
    ...
    class ServiceEvent:
        ...
        def Execute(self):
            ...
            print("\nTime %d" % self.eTime, "Service for server %i" % serverId, "is finished")
    ...
    DrawSampleHistogram([x.waitingTimeInQueue for x in DEVS.stats], "shortest")
